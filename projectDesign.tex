...
\begin{figure}[t]
    \centering
    % Why is he both a professional and a casual teacher? Seems like a typo?
...
% There is something weird going on with the paragraph formatting here. A new
% paragraph in LaTeX is created when you use a blank line.
...
During the ``discovery'' and ``define'' phases of the Double Diamond framework, the team realised that one of the most key user journeys on the platform, was the sign-up journey.
...
\begin{figure}[h]
    \centering
    \rotatebox{90}{\includegraphics[width=10cm]{wireframe-authentication}}
...
% This section is very confusing to me. You keep contradicting yourself. First we did not create HF prototypes, then you say we "kind of" created LF prototypes (plural) but it is actually a HF prototype (singular).
...
% I think you could use `--` or `---` instead of the longer hyphen symbol to get the formatting right.
