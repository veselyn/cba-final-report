...
\begin{figure}[h]
    \centering
    \includegraphics[width=5cm]{reusable-skills-exchange}
    \includegraphics[width=5cm]{reusable-accordeon-2}
    \label{fig:reusable-components}
\end{figure}
\clearpage
\section{Wireframes}\label{sec:wireframes}
\begin{figure}[h]
    \includegraphics[width=7cm]{wireframe-profile}
    \includegraphics[width=7cm]{wireframe-profile-view}
    \includegraphics[width=7cm]{wireframe-wallet}
