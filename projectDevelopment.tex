...
Initially, three different style tiles were created, and the team decided to go with the one that had a mix of pastel and warm colors, as well as a modern and clean font.
All three versions were focused on the same concept of ``knowledgeable, reliable, and accessible''.
