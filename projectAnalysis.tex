...
% Shouldn't the list here, the picture, and the list below the picture share the same names?
\begin{itemize}
...
% I would other this list like in the picture -- left to right, top to bottom. Also, picture uses Power but list uses Influence
...
% Nit: I also found the list of skills to be a bit confusing. I read programming and
% languages as "programming languages" and I thought that it was unnecessary to
% use "or even" when listing only one thing. I would list at least three things
% and then say "or even".
...
% Nit: I think feedback is too generic. Rating is also considered feedback. Maybe use "review"?
